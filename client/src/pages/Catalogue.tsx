...
export default function Catalogue() {
  ...
  return <div className="min-h-screen bg-[#f8fafc] text-slate-950">
    <SEO
      title="Industrial Product Catalogue & Tools Finder | M.A.S. Traders Kovilpatti"
      description="Search Kovilpatti's comprehensive 21-division catalogue: power tools, hand tools, pipes, hardwares, electricals, fasteners, safety equipment, and construction materials."
      keywords="industrial tools catalogue Kovilpatti, power tools price Kovilpatti, hardware supplies near me, pipes and fittings catalogue, safety equipment Kovilpatti, M.A.S. Traders"
      canonical="/catalogue"
    />
    <SiteHeader/><main className="pt-24 sm:pt-28"><MotionReveal className="page-hero"><div className="section-rail">02 / FINDER</div><div><p className="technical-label text-blue-700">PRODUCT FINDER / {currentProducts.length} CURRENT PRODUCTS</p><h1 className="mt-4 max-w-3xl text-5xl font-bold leading-[0.95] tracking-[-0.065em] sm:text-7xl">Find what you need.</h1><p className="mt-6 max-w-xl text-base leading-7 text-slate-600">Search the current M.A.S. Traders product range by product name or category, then move into a focused category listing when you are ready to browse everything.</p></div></MotionReveal>
